...
<body >
 <center> <img src="prakash.PNG" height="80px" width="800px" ><br></center>
	...
	<center>
	<h1 style="color:white; text-shadow: 4px 4px black;  font-size: 30px; font-family: Cooper;">Change password</h1>
	<form action="changeps_task.jsp" method="post">
  <fieldset style="background-color: #FFFFE0; border-color: red; border-width: 8px; width: 400px; height: 500px;">
   ...
   <br><input type="text" name="username" placeholder="user id" required="required"><br>
