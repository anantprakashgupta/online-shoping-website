...
%>
	...
	<center>						
	<h1 style="margin-top:60px; color:white; text-shadow: 4px 4px black;  font-size: 30px; font-family: Lucida Calligraphy;">upadte Category here...</h1>
	<form action="edit_category_task.jsp" method="post">
  <fieldset style=" border-color: white; border-width: 8px; width: 400px; height: 280px;">
   ...
   <input type="submit" value="upadte"><br><br>
